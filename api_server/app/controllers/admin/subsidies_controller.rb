module Admin
  class SubsidiesController < ApplicationController
    def index
      ...
      filter_params = params.slice(:publishing_code, :end_after, :keyword, :subsidy_category, :sorting_code)
      scope = scope.admin_filter(filter_params).order(updated_at: :desc)

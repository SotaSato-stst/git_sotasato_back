...
if Rails.env.development?
  ...
  subsidy_hashes = [
    ...
    },
    {
      ...
      capital_max: 50000000,
      capital_min:nil,
      total_employee_max: 200000,
      total_employee_min: 50000,
    ...
    },
    {
      ...
      supplier_type: 'city',
      ranking_score: 50,
      capital_max: 50900000000000,
      capital_min:100000000,
      total_employee_max: 20,
      total_employee_min: 2,
      business_categories: ['gyogyo'],
    },
    {
  ...
  subsidy_hashes.each do |hash|
    ...
    subsidy.update!(
      ...
      capital_max: hash[:capital_max],
      capital_min: hash[:capital_min],
    )
  end
  company_hashes = [
    {

...
if Rails.env.development?
  ...
  subsidy_hashes = [
    ...
    },
    {
      ...
      business_categories: ['hotel_insyoku'],
      annual_sales_max: nil, 
      annual_sales_min: nil,
      years_of_establishment: nil,
      catch_copy: '',
    ...
    },
    {
      ...
      capital_max: nil,
      capital_min:nil,
      business_categories: ['koumu'],
      total_employee_max: nil,
      total_employee_min: nil,
      annual_sales_max: nil, 
      annual_sales_min: nil,
      years_of_establishment: nil,
      catch_copy: '【コロナの影響を受けた全ての中小法人・個人事業者が給付対象！】',
      keywords: ['中小企業', 'コロナ関連'],
    },
    {
  ...
  subsidy_hashes.each do |hash|
    ...
    # subsidy.subsidy_keywords = hash[:keywosubsidy_keywords].map do |content|
    #   subsidy.subsidy_keywords.build(keyword: content)
    # end

  ...
  subsidy_hashes = [
    {
      ...
      level: '1',
      detail: '### 支援内容 ものづくり・商業・サービス生産性向上促進補助金は、中小企業・小規模事業者等が今後複数
    ...
    },
    {
      ...
      support_ratio_max: '1/2',
      level: 2,
      detail: '### 支援内容 本事業は、民間団体等が行う、運航計画・配船計画・RORO船等荷役の最適化等のソフト面の対策や、当該対策を前提とした省エネルギー船型、高効率推進システム（バッテリー推進のものを含む。）、荷役効率化設備（スマート電動ウインチ、荷役設備向け陸上電力受電設備等）等のハード面の対策の導入による輸送全体の最適化を目指した実証事業（後年度事業を含む。）の実施に要する経費を補助することにより、海上輸送部門における省エネルギーを推進し、もって、内外の経済的社会的環境に応じた安定的かつ適切なエネルギーの需給構造の構築を図るものです。\n### 対象\n補助対象事業
    ...
    },
    {
      ...
      support_ratio_max: '',
      level: 4,
      detail: '### 支援内容 中小企業庁では、新型コロナウイルス感染症の拡大や長期化に伴う需要の減少又は供給の制約により大きな影響を受け、自らの事業判断によらずに売上が大きく減少している中堅企業、中小法人及び個人事業者に対して、事業の継続・回復を支援する事業復活支援金の申請受付を１月３１日（月）より行っています。\n### 対象\n　下記(1)、(2)を満たす中小法人・個人事業者
    ...
    },
    {
      ...
      support_ratio_max: '1/2',
      level: 4,
      detail: '### 支援内容 この補助金は、県内の中小企業者等が事業継続計画（以下「ＢＣＰ」という。）の策定並びにその実効性向上のためのＢＣＰの改善及び必要な防災措置に要する経費を支援し、もって県内中小企業等の災害対応力の強化を図ることを目的とします。\n### 対象\n 防災措置型	

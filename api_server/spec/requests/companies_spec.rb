...
RSpec.describe 'Companies', type: :request do
  ...
  let!(:company) do
    create(:company, name: '池垣株式会社', prefecture: prefecture, city: city, adress: 'つくば市天久保3丁目12-34', capital: 200000, total_employee: 200, business_scale: 'large' )
  end
  ...
  describe 'GET /companies' do
    ...
    it 'returns object' do
      ...
      expect(json['companies'][0]['capital']).to eq 200000
  ...
  describe 'GET /companies/:id' do
    ...
    it 'returns object' do
      ...
      expect(json['capital']).to eq 200000
